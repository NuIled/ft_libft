...
SRCS =ft_putchar_fd.c ft_striteri.c ft_strmapi.c ft_itoa.c ft_strtrim.c  ft_strjoin.c  ft_substr.c  ft_strnstr.c ft_memcpy.c   ft_strdup.c    ft_calloc.c  ft_memset.c   ft_bzero.c \
